    ...
    <SheetPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          side === "top" && "inset-x-0 top-0 border-b-3 border-foreground",
          side === "bottom" && "inset-x-0 bottom-0 border-t-3 border-foreground",
          side === "left" && "inset-y-0 left-0 h-full w-3/4 border-r-3 border-foreground sm:max-w-sm",
          side === "right" && "inset-y-0 right-0 h-full w-3/4 border-l-3 border-foreground sm:max-w-sm",
          className
        )}
        {...props}
      >
...
const SheetTitle = React.forwardRef(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn("text-lg font-bold uppercase tracking-wider text-foreground", className)}
    {...props}
  />
))
